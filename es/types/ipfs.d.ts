...
export interface IPFS extends EventEmitter {
    types: Types;
...
export declare type InstanceIPFS = IPFS;
...
export declare type Multihash = any | string;
...
export declare type FileContent = Record<string, any> | Blob | string;
/** old version? */
...
export declare type PeerId = any;
...
export declare type DAGNode = any;
export declare type DAGLink = any;
export declare type DAGLinkRef = DAGLink | any;
export declare type Obj = BufferSource | Record<string, any>;
...
declare type TPubSubTopic = string;
declare type TpubSubTopicHandler = (msg: any) => void;
declare type TPubSubTopicOptions = {
    discover: boolean;
};
declare type TPubSubData = string | Buffer;
...
export declare type KeyType = string | Buffer | CID | any;
