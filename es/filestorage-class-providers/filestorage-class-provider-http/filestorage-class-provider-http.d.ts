...
export declare class FileStorageClassProviderHTTP implements IFileStorageService<FILE_STORAGE_SERVICE_TYPE.HTTP> {
    ...
    close(): Promise<void>;
    add: (filename: string, file: TFileStorageFile, options?: {} | undefined) => Promise<TFileStorageFileAddress>;
    get: (addr: TFileStorageFileAddress, options?: IFileStorageClassProviderHTTPFileGetOptions | undefined) => Promise<File>;
    download: (addr: TFileStorageFileAddress, _options?: IFileStorageClassProviderHTTPFileAddOptions | undefined) => Promise<void>;
